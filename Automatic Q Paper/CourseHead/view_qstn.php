...
<div class="container-fluid">
		...
		<div class="row">
			...
			if($Questions=$dao->select_array(array("*"),"insertquestion","s_id='".$_REQUEST['sub']."' order by q_status"))
			{
			?>
			<div class="row" style="background-color:yellowgreen">
				<div  class="col-md-5 col-xs-5 col-sm-5" style="font-size:20px; padding-right:3px;">
					Question
				</div>
			...
			<div class="row">
				<div  class="col-md-5 col-xs-5 col-sm-5"  style="padding-right:3px;">
					<?php echo $q['Question']; ?>
				</div>
				...
				<?php
				if($q['q_status']=='removed')
				{
				?>
					<div class="col-md-1 col-xs-1 col-sm-1">Removed
					</div>
					</div>
				<?php
					}
				else
				{
					?>
					<div class="col-md-1 col-xs-1 col-sm-1">
						 <a href="remove1.php?id=<?php echo $q['q_id']; ?>">Remove</a>
					</div>
				</div>
					<?php
				}
